(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (json-mode sr-speedbar jsx-mode git-gutter+ markdown-mode+ gruvbox-theme zenburn-theme neotree nav dired-subtree treemacs dired-sidebar vlf ein bison-mode tide js3-mode git-timemachine yoshi-theme which-key web-mode virtualenv use-package tuareg try suscolors-theme smex smart-mode-line-powerline-theme shader-mode rainbow-delimiters ox-twbs ox-gfm org-bullets org-beautify-theme org-babel-eval-in-repl ob-ipython moe-theme mode-icons markdown-mode magit jedi ivy-hydra importmagic highlight-parentheses git-gutter-fringe forecast ess ein-mumamo edit-server dired-k counsel company colonoscopy-theme babel anaconda-mode)))
 '(scroll-bar-mode nil)
 '(standard-indent 2)
 '(tool-bar-mode nil)
 '(xterm-mouse-mode t))
